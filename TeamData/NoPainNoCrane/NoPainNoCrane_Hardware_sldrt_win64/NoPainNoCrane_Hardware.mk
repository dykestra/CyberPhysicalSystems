...
MODEL                := NoPainNoCrane_Hardware
MODULES              := NoPainNoCrane_Hardware_data.c NoPainNoCrane_Hardware_tgtconn.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := NoPainNoCrane_Hardware.mk
...
#
MODELLIB                  := NoPainNoCrane_Hardwarelib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := NoPainNoCrane_Hardware_ref.rsp
MODELREF_INC_PATH         := 
