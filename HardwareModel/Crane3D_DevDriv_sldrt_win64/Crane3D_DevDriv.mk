...
MODEL                := Crane3D_DevDriv
MODULES              := Crane3D_DevDriv_data.c Crane3D_DevDriv_tgtconn.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Crane3D_DevDriv.mk
...
#
MODELLIB                  := Crane3D_DevDrivlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Crane3D_DevDriv_ref.rsp
MODELREF_INC_PATH         := 
