...
#ifndef RTW_HEADER_Crane3D_DevDriv_2Contr_h_
#define RTW_HEADER_Crane3D_DevDriv_2Contr_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef Crane3D_DevDriv_2Contr_COMMON_INCLUDES_
# define Crane3D_DevDriv_2Contr_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* Crane3D_DevDriv_2Contr_COMMON_INCLUDES_ */

#include "Crane3D_DevDriv_2Contr_types.h"
...
#define Crane3D_DevDriv_2Contr_rtModel RT_MODEL_Crane3D_DevDriv_2Contr_T
...
typedef struct {
  ...
  real_T ProportionalGain_j;           /* '<S8>/Proportional Gain' */
  real_T DerivativeGain_f;             /* '<S8>/Derivative Gain' */
  real_T FilterCoefficient_g;          /* '<S8>/Filter Coefficient' */
  real_T ProportionalGain_o;           /* '<S10>/Proportional Gain' */
  real_T DerivativeGain_c;             /* '<S10>/Derivative Gain' */
  real_T FilterCoefficient_e;          /* '<S10>/Filter Coefficient' */
  real_T ProportionalGain_f;           /* '<S9>/Proportional Gain' */
  real_T DerivativeGain_m;             /* '<S9>/Derivative Gain' */
  real_T FilterCoefficient_o;          /* '<S9>/Filter Coefficient' */
  real_T IntegralGain;                 /* '<S7>/Integral Gain' */
  real_T IntegralGain_a;               /* '<S8>/Integral Gain' */
  real_T IntegralGain_p;               /* '<S9>/Integral Gain' */
  real_T IntegralGain_g;               /* '<S10>/Integral Gain' */
  real_T PWM[3];                       /* '<S3>/PWM' */
...
typedef struct {
  ...
  real_T Filter_CSTATE_p;              /* '<S8>/Filter' */
  real_T Integrator_CSTATE_d;          /* '<S10>/Integrator' */
  real_T Filter_CSTATE_p4;             /* '<S10>/Filter' */
  real_T Integrator_CSTATE_a;          /* '<S9>/Integrator' */
  real_T Filter_CSTATE_n;              /* '<S9>/Filter' */
} X_Crane3D_DevDriv_2Contr_T;
...
typedef struct {
  ...
  boolean_T Filter_CSTATE_p;           /* '<S8>/Filter' */
  boolean_T Integrator_CSTATE_d;       /* '<S10>/Integrator' */
  boolean_T Filter_CSTATE_p4;          /* '<S10>/Filter' */
  boolean_T Integrator_CSTATE_a;       /* '<S9>/Integrator' */
  boolean_T Filter_CSTATE_n;           /* '<S9>/Filter' */
} XDis_Crane3D_DevDriv_2Contr_T;
...
#define rtB                            Crane3D_DevDriv_2Contr_B
#define BlockIO                        B_Crane3D_DevDriv_2Contr_T
#define rtX                            Crane3D_DevDriv_2Contr_X
#define ContinuousStates               X_Crane3D_DevDriv_2Contr_T
#define rtXdot                         Crane3D_DevDriv_2Contr_XDot
#define StateDerivatives               XDot_Crane3D_DevDriv_2Contr_T
#define tXdis                          Crane3D_DevDriv_2Contr_XDis
#define StateDisabled                  XDis_Crane3D_DevDriv_2Contr_T
#define rtP                            Crane3D_DevDriv_2Contr_P
#define Parameters                     P_Crane3D_DevDriv_2Contr_T
#define rtDWork                        Crane3D_DevDriv_2Contr_DW
#define D_Work                         DW_Crane3D_DevDriv_2Contr_T

/* Parameters (auto storage) */
struct P_Crane3D_DevDriv_2Contr_T_ {
  real_T AngleDX;                      /* Variable: AngleDX
                                        * Referenced by: '<S8>/Derivative Gain'
                                        */
  real_T AngleDY;                      /* Variable: AngleDY
                                        * Referenced by: '<S9>/Derivative Gain'
                                        */
  real_T AngleIX;                      /* Variable: AngleIX
                                        * Referenced by: '<S8>/Integral Gain'
                                        */
  real_T AngleIY;                      /* Variable: AngleIY
                                        * Referenced by: '<S9>/Integral Gain'
                                        */
  real_T AnglePX;                      /* Variable: AnglePX
                                        * Referenced by: '<S8>/Proportional Gain'
                                        */
  real_T AnglePY;                      /* Variable: AnglePY
  ...
  real_T PC1y;                         /* Variable: PC1y
                                        ...
                                        */
  real_T waypoints[50];                /* Variable: waypoints
...
struct tag_RTM_Crane3D_DevDriv_2Contr_T {
  const char_T *path;
...
extern P_Crane3D_DevDriv_2Contr_T Crane3D_DevDriv_2Contr_P;

/* Block signals (auto storage) */
extern B_Crane3D_DevDriv_2Contr_T Crane3D_DevDriv_2Contr_B;

/* Continuous states (auto storage) */
extern X_Crane3D_DevDriv_2Contr_T Crane3D_DevDriv_2Contr_X;

/* Block states (auto storage) */
extern DW_Crane3D_DevDriv_2Contr_T Crane3D_DevDriv_2Contr_DW;

/* Model entry point functions */
extern void Crane3D_DevDriv_2Contr_initialize(void);
extern void Crane3D_DevDriv_2Contr_output(void);
extern void Crane3D_DevDriv_2Contr_update(void);
extern void Crane3D_DevDriv_2Contr_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Crane3D_DevDriv_2Contr_rtModel *Crane3D_DevDriv_2Contr(void);
...
extern RT_MODEL_Crane3D_DevDriv_2Contr_T *const Crane3D_DevDriv_2Contr_M;
 ...
 *
 * '<Root>' : 'Crane3D_DevDriv_2Contr'
 * '<S1>'   : 'Crane3D_DevDriv_2Contr/Controller'
 * '<S2>'   : 'Crane3D_DevDriv_2Contr/Convert Coordinates'
 * '<S3>'   : 'Crane3D_DevDriv_2Contr/Crane 3D'
 * '<S4>'   : 'Crane3D_DevDriv_2Contr/Select most convenient path'
 * '<S5>'   : 'Crane3D_DevDriv_2Contr/Controller/Enforce Soft Limits and Overflow'
 * '<S6>'   : 'Crane3D_DevDriv_2Contr/Controller/PID Controler'
 * '<S7>'   : 'Crane3D_DevDriv_2Contr/Controller/PID Controler/PID Controller'
 * '<S8>'   : 'Crane3D_DevDriv_2Contr/Controller/PID Controler/PID Controller1'
 * '<S9>'   : 'Crane3D_DevDriv_2Contr/Controller/PID Controler/PID Controller2'
 * '<S10>'  : 'Crane3D_DevDriv_2Contr/Controller/PID Controler/PID Controller5'
 */
#endif                                 /* RTW_HEADER_Crane3D_DevDriv_2Contr_h_ */
