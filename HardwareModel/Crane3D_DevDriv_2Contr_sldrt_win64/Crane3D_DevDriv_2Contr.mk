...
MODEL                := Crane3D_DevDriv_2Contr
MODULES              := Crane3D_DevDriv_2Contr_data.c Crane3D_DevDriv_2Contr_tgtconn.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Crane3D_DevDriv_2Contr.mk
MATLAB_ROOT          := C:/matlab/R2016a
MATLAB_BIN           := C:/matlab/R2016a/bin
S_FUNCTIONS          := Crane3D_Encoder.c Crane3D_PWM.c Crane3D_LimitFlag.c Crane3D_SetLimit.c Crane3D_Switch.c Crane3D_PWMPrescaler.c Crane3D_ResetEncoder.c Crane3D_ResetSwitchFlag.c Crane3D_ThermFlag.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
...
#
MODELLIB                  := Crane3D_DevDriv_2Contrlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Crane3D_DevDriv_2Contr_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;$(MATLAB_ROOT)/simulink/include/sf_runtime;H:/repos/CyberPhysicalSystems/HardwareModel/Crane3D_DevDriv_2Contr_sldrt_win64;H:/repos/CyberPhysicalSystems/HardwareModel;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
